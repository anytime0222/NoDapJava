...
public class yeongumGaesangi2 {
	public static void main(String[] args) {
		...
		for (int i = 0 ; i<howLongMonth; i++) {
			fuckTotalMoney +=  primeMoney * (monthsMinus/100) ;
			
		}
		System.out.println("");		
		System.out.println(fuckTotalMoney);		
...
//2020년 10.25 61개월 받을때 19,309,245원
//2021년 10.25 60개월 받을때 20,609,100원 76.5